...
#                     #print(list(np.asarray(incData, dtype='object')[tuple([self.base.emgChannelsIdx])]))
#                     self.inc = 0
    ...
    def vispyPlot(self):
        ...
        while self.pauseFlag is False:
            if len(self.emg_plot) >= 2:
                ...
                #self.inc = 0
                #print("BELLA IS A MEANY")
                last_array1 = incData[-1]
                last_array2 = last_array1[-1]
                #print(last_array2)
                ...
                try:
                    ...
                    #     servo_positions = open_fingers()
                    #     write_servos(servo_positions)
                    data1 = [self.emg_plot[0][i][0] for i in self.base.emgChannelsIdx]
                    data2 = abs(data1[0])
                    if (data2>0.1 and data2<0.8):
                        print("FLEXED")
                        print(self.inc)
                        self.inc += 1
